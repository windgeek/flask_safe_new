...
# if __name__ == '__main__':
    ...
    scan_data = add('Test Scan', 'Create a new scan with API', '172.28.9.180', policy_id)
    ...
    # print('Logout')
    # logout()
    cmd = "../nessus_report.py -i 172.28.5.228 -u admin -p xxxxxx -s {} -f 2".format(scan_id)
    import sshclient
